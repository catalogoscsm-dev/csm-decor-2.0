...
const PRODUTOS_JSON = path.join(__dirname, 'artecouro2-produtos.json');
...
function injectIntoHtml(cards) {
  ...
  content = content.replace(
    /\n\s*<!-- INICIO ARTECOURO2 -->[\s\S]*?<!-- FIM ARTECOURO2 -->/g, ''
  );
...
function main() {
  ...
  console.log(`\nImportando ${produtos.length} produtos Artecouro Concept (catálogo 2)...\n`);
  ...
  console.log(`\n✅ produtos.html atualizado com ${produtos.length} produtos da Artecouro (catálogo 2)!\n`);
}
